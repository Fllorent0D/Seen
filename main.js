...
nconf.file({
    file: path.join(__dirname, 'token.json')
});
...
ipc.on("openLoginWindow", () => {
    loginwindows = new BrowserWindow({
        width: 500,
        height: 600
    });
